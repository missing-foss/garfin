...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String librarySemanticCollection(int count) {
    return 'Collection, $count titles';
  }
  ...
  String collectionTitleCount(int count) {
    return '$count titles in this collection';
  }

  @override
  String get collectionGiveWholeSet => 'Give the whole set';

  @override
  String get collectionEmpty => 'Nothing in this collection.';
  ...
  String sessionsStopStopped(String device) {
    return '$device stopped playing.';
  }

  @override
  String sessionsStopIgnored(String device) {
    return 'Asked $device to stop, but it\'s still playing.';
  }
  ...
  String sessionsEndReturned(String device) {
    return '$device signed out, then signed straight back in.';
  }
