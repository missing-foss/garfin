...
class SettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Capped at a readable width (#95). A settings row is a label and a
    // control, and on a 1280dp window an uncapped row parks the switch a hand's
    // width from the thing it switches.
    return ReadableList(
