...
class _AboutScreenState extends ConsumerState<AboutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // The screen with the most prose on it, so the width cap (#95) matters
      // here before anywhere else: the licence paragraph runs the full 1280dp
      // of a tablet in landscape otherwise.
      body: ReadableList(
