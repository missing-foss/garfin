...
Garfin is licensed under the GNU General Public License v3.0 or later.

The full text is in [`LICENSE`](LICENSE) at the repository root.

    Garfin — Jellyfin parental controls by tag
    Copyright (C) 2026  missing_foss@etik.com
...
Bundled fonts keep their own licences. All three families are SIL OFL 1.1 and their licence
files ship with the app in `assets/fonts/`:
